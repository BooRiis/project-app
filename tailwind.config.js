...
module.exports = {
  mode: 'jit',
  purge: [
    './apps/project-app/src/**/*.{ts,tsx,html}',
  ],
  darkMode: 'media',
  important: ':root',
  theme: {
    ...
    maxWidth: {
      'card-popover': '24rem',
      'input-action-icon': '3rem',
      'date-number': '3.125rem',
    },
    maxHeight: {
      'select-dropdown': '20.5rem',
    },
    backgroundImage: {
    ...
    extend: {
      boxShadow: {
        ...
        fakeinset: 'inset 0px 0px 0px 1px #DADADA',
        fakeinset2: 'inset 0px 0px 0px 1px #D8A558',
        fakeinset3: 'inset 0px 0px 0px 1px #1B2733',
        fakeinset4: 'inset 0px 0px 0px 1px #969696',
        popover: '0px 4px 24px rgba(0, 0, 0, 0.08)',
        widget: '0px 2px 12px rgba(0, 0, 0, 0.08)',
        outline: 'inset 0px 0px 0px 1px #DADADA',
      ...
      width: theme => ({
        ...
        full: '100%',
        screen: '100vw',
        'main-layout-left-panel': '21.25rem',
        'sepa-form': '22.5rem',
        'currency-detail-form': '10rem',
        'authorization-table': '44.37rem',
        'modal-window': '23.75rem',
        'mail-box': '48rem',
        'language-select': '9rem',
        'alert-box': '20rem',
      }),
      zIndex: {
        auto: 'auto',
